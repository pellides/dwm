...
static const Key keys[] = {
	...
	{ MODKEY,		XK_x,		spawn,		SHCMD("anki") },
	{ MODKEY,			XK_c,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "profanity", NULL } } },
	/* { MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("") }, */
	/* V is automatically bound above in STACKKEYS */
	{ MODKEY,			XK_b,		togglebar,	{0} },
	{ MODKEY|ShiftMask,		XK_b,		spawn,		SHCMD("zb") },
	...
	{ 0,				XK_Print,	spawn,		SHCMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle") },
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		{.v = (const char*[]){ "brillo", "-q", "-A", "5", NULL } } },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		{.v = (const char*[]){ "brillo", "-q", "-U", "5", NULL } } },
